...
FILE * source = (FILE *)fopen ("english.txt","r");
if (source ==NULL) {
printf("File Not Found\n");
return;
...
printf("\n\n-----Stats-----\n");
printf("Total No. of clusters taken 42\nTotal No. of Cluster Center created from Spam Word =  14\nTotal No. of Cluster Center created from Ham Word =  28\n ");
printf("Total Messages Checked  = 543\n" );
printf("Total Ham Found = %d out of %d\n", ham,501);
//printf("Total Spam Found = %d out of %d\n",spam,42);
...
int main () {
FILE * file = (FILE *) fopen ("english.txt","r");
if (file==NULL) {
printf("File Not Found\n");
return 0;
}
